...
3. Hãy nhập số điện thoại hoặc email của bạn.
4. Người dùng nhập **Số điện thoại hoặc email**.
5. Nhấn nút **“Tiếp tục”**.
...
5. Hệ thống hiển thị trang **“Chọn phương thức đăng nhập”**, hiển thị thông tin tài khoản (avatar + tên) và các phương thức nhận mã OTP khả dụng dựa trên thông tin liên hệ đã đăng ký và được cung cấp ở Bước 1.
6. Người dùng chọn một phương thức nhận mã OTP:
   - **Nếu tài khoản chỉ có email đã đăng ký:** Chỉ hiển thị "Nhận mã qua email".
   - **Nếu tài khoản có cả email và số điện thoại đã đăng ký:** Hiển thị cả "Nhận mã qua email" và "Nhận mã qua SMS".
   - (Luôn có) "Tiếp tục bằng mật khẩu" (nếu người dùng muốn quay lại đăng nhập bằng mật khẩu).
7. Nhấn nút **“Tiếp tục”**.
...
- Vì email là trường bắt buộc khi đăng ký, tùy chọn "Nhận mã qua email" sẽ luôn khả dụng. Tùy chọn "Nhận mã qua SMS" sẽ hiển thị nếu tài khoản có số điện thoại đã đăng ký.
...
- Hệ thống hiển thị trang “Chọn phương thức đăng nhập”  
Then  
- Hệ thống gửi mã OTP và chuyển đến trang “Xác nhận tài khoản”
- **Nếu tài khoản chỉ có email đã đăng ký:** Chỉ hiển thị tùy chọn "Nhận mã qua email" và "Tiếp tục bằng mật khẩu".
- **Nếu tài khoản có cả email và số điện thoại đã đăng ký:** Hiển thị cả "Nhận mã qua email", "Nhận mã qua SMS" và "Tiếp tục bằng mật khẩu".
- Người dùng chọn một phương thức và nhấn “Tiếp tục” → Hệ thống gửi mã OTP và chuyển đến trang “Xác nhận tài khoản”.
